...
#define DEFAULT_STARTANGLE -210 //默认开始度数

#define DEFAULT_ENDANGLE 30 //默认结束度数

#define MAX_PROGRESS_LINE_WIDTH 45 //弧线的最大宽度

@interface YYAshapelGradientView ()
{
    UISlider *_slider;
...
@implementation YYAshapelGradientView
